#### 강좌 가격을 변경하고 싶어요.
최초에 강좌 공개 시 선생님이 직접 업로드한 콘텐츠의 가격을 설정할 수 있습니다.
이후 강좌 가격을 변경하길 원하시는 경우 '가격 변경 신청'을 해주시기 바랍니다.
변경 가격과 사유를 검토한 후 선생님께 이메일과 쪽지를 통해 연락드립니다. 강좌 가격 변경은 기존 수강생 및 신규 수강생 사이의 불이익이 없도록 하기 위해 신중히 진행되는 절차인 점을 양해해주시기 바랍니다.
...
강좌 할인율, 할인기간과 같은 구체적인 사항은 1:1 문의에 적어주셔야 하고 유선 상의 협의가 필요한 사항들은 선생님과 연락 후에 결정됩니다.
